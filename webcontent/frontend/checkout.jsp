...
<jsp:include page="page_head.jsp">
	<jsp:param value="Checkout" name="pageTitle" />
</jsp:include>
<body>
	<div class="container">
					...
					<div class="card-body">
						<form id="orderForm" action="place_order" method="post">
							<div class="form-group row">
								<label class="col-sm-4 col-form-lable">FirstName:</label>
								<div class="col-sm-8">
							...
							<div class="form-group row">
								<label class="col-sm-4 col-form-lable">LastName:</label>
								<div class="col-sm-8">
							...
							<div class="form-group row">
								<label class="col-sm-4 col-form-lable">Phone:</label>
								<div class="col-sm-8">
									<input type="text" name="phonenumber" required minlength="10"
										maxlength="15" class="form-control"
										value="${loggedcustomer.phoneNumber}">
								</div>
							</div>
							<div class="form-group row">
								<label class="col-sm-4 col-form-lable">Address Line 1:</label>
								<div class="col-sm-8">
									<input type="text" name="address1" required minlength="10"
							...
							<div class="form-group row">
								...
								<div class="col-sm-8">
									<input type="text" name="address2" required minlength="10"
										maxlength="256" class="form-control"
							...
							<div class="row">&nbsp;</div>
							<div class="form-group row">
								<label class="col-sm-4 col-form-lable">Choose your
